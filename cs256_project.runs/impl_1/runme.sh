...
HD_PWD='/home/khogeesa/Desktop/cs256_project/fpga/cs256_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project_toplevel.tcl -notrace
