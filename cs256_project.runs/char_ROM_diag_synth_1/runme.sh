...
HD_PWD='/home/khogeesa/Desktop/cs256_project/fpga/cs256_project.runs/char_ROM_diag_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log char_ROM_diag.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source char_ROM_diag.tcl
