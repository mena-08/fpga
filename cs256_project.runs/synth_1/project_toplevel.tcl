...
synth_design -top project_toplevel -part xc7a100tcsg324-1
...
write_checkpoint -force -noxdef project_toplevel.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file project_toplevel_utilization_synth.rpt -pb project_toplevel_utilization_synth.pb"
