...
HD_PWD='/home/khogeesa/Desktop/cs256_project/fpga/cs256_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_toplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_toplevel.tcl
