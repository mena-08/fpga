...
HD_PWD='/home/khogeesa/Desktop/cs256_project/fpga/cs256_project.runs/enemy_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enemy_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source enemy_ROM.tcl
